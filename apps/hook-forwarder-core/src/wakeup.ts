...
export function pingHealth(port: number, timeoutMs = 500): Promise<boolean> {
 ...
 */
export async function wakeupCompanion(port: number, log: (msg: string) => void = () => {}): Promise<boolean> {
